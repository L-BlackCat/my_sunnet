...
void ConnWriter::EntireWithEmpty(shared_ptr<char> buff,streamsize len){
...
void ConnWriter::EntireWithNoEmpty(shared_ptr<char> buff,streamsize len){
    auto obj = make_shared<WriteObject>();
    obj->start = 0;
    obj->buff = buff;
    obj->len = len;
